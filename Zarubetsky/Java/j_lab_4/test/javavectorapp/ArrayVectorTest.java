...
public class ArrayVectorTest {
    ...
    @Test(expected = vector.Exceptions.VectorIndexOutOfBoundsException.class)
    ...
    @Test(expected = vector.Exceptions.IncompatibleVectorSizesException.class)
    public void testSumException1() throws vector.Exceptions.IncompatibleVectorSizesException{
    ...
    @Test(expected = vector.Exceptions.IncompatibleVectorSizesException.class)
    public void testSumException2() throws vector.Exceptions.IncompatibleVectorSizesException{
        System.out.println("sumException (vector sizes < new vector sizes)");
        // Arrange
        double[] mass = {5.0, -2.9, 0.0, -50000, 9};
